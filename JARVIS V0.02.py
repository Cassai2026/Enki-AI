...
import pyttsx3  # Make sure you import pyttsx3 for the TTS engine

# ---------- VOICE SETUP ----------
engine = pyttsx3.init()  # Initialize the pyttsx3 engine for custom voice
engine.setProperty("rate", 170)  # Set speech rate

# Set the Piper voice (replace with the voice you want to use, like en_GB-alba-medium)
engine.setProperty('voice', "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech_OneCore\\Voices\\en-US\\Alba")  # Replace with your correct voice path

def speak(text: str):
    """Speak out the text using pyttsx3 engine."""
    engine.say(text)
    engine.runAndWait()
